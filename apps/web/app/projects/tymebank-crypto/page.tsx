        ...
        <div>
          ...
          <section className="relative px-6 pt-28 pb-16 md:px-[250px] md:pt-36 md:pb-24">
            ...
            <p className="mt-6 max-w-[50ch] text-xl leading-relaxed font-light text-muted-foreground md:text-2xl">
              ...
              inside its own app. Designed for people who had never
              bought a coin.
            </p>
            ...
            <p className="mt-12 max-w-[58ch] text-base leading-relaxed text-muted-foreground md:ml-[15%] md:text-lg">
              ...
              compliance in the background. The design challenge was to make
              all of that invisible: a banking experience that happened to
            ...
            <div className="mt-10 grid gap-8 md:mt-14 md:grid-cols-2 lg:grid-cols-3 md:gap-12">
              {[
                ...
                },
                {
                  ...
                  content:
                    "The full buy/sell lifecycle: discovery on the home screen, story-format onboarding, coin selection and detail, amount entry with live balance impact, order confirmation, success state, and all error and edge-case flows — on both iOS and Android.",
                },
                {
                  title: "The Central Bet",
                  content:
                    "Trust had to be built at the moment of entering an amount, not in the onboarding screens. The design bet was that making the transaction legible — real-time balance changes, live price, honest disclaimers — would lower abandonment more than any marketing surface.",
                },
                {
          ...
          <section id="context" className="px-6 py-24 md:px-[250px] md:py-32">
            ...
            <h2 className="mt-4 max-w-[22ch] text-3xl font-medium tracking-tight md:text-4xl">
              A bank, a blockchain, and a country discovering both
            </h2>
            <div className="mt-12 grid gap-12 md:grid-cols-[1.5fr_0.7fr] md:gap-20">
              <div className="space-y-6 text-base leading-relaxed text-muted-foreground md:text-lg">
                ...
                <p>
                  In 2020–2021, South Africa had one of the highest crypto
                ...
                <p>
                  ...
                  themselves. The design task was to build the experience layer
                  on top — something that felt like TymeBank from start to finish,
                  with crypto as the subject matter and the bank as the trusted
                  counterparty.
                </p>
              </div>
          ...
          <section id="problem" className="px-6 py-24 md:px-[250px] md:py-32">
            ...
            <div className="mt-16">
              <ImagePlaceholder
                ...
                caption="Compliance gates designed as moments, not walls — each with clear language and a path forward"
              ...
              <div className="space-y-10">
                ...
                <div>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    ...
                    conversion lever. The first-buy completion rate was.
                  </p>
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-border/30 bg-muted/10 p-6">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground/60">
                    ...
                    coin equivalent is secondary information. Rand literacy is
              ...
              {[
                {
                  ...
                  decision:
                    "A persistent &quot;Before / After&quot; bar sits at the top of the amount screen throughout the entire input. It updates in real time. The user can see their account balance decreasing as they type, before pressing any button. Balance impact moves from a post-error to a pre-decision.",
                  tradeoff:
                    "This required the balance bar to be prominently placed at the expense of screen real estate in an already constrained mobile layout. The amount input and keyboard take up most of the viewport. The bar had to be compact but legible.",
                ...
                },
                {
                  ...
                  observation:
                    "Crypto prices move. Showing a live price and then transacting at a different price feels like bait-and-switch to users who don't understand indicative pricing. This is a structural feature of how crypto settlement works — not a product decision — but it had to be communicated as if it were a design decision.",
                  decision:
          ...
          <section id="solution" className="px-6 py-24 md:px-[250px] md:py-32">
            ...
            <h2 className="mt-4 max-w-[22ch] text-3xl font-medium tracking-tight md:text-4xl">
              The full buy/sell lifecycle — inside the bank
            </h2>
            <p className="mt-8 max-w-[58ch] text-base leading-relaxed text-muted-foreground md:text-lg">
            ...
            <div className="mt-20 md:mt-32">
              ...
              <div className="mt-8 grid gap-8 md:grid-cols-2 md:gap-16">
                ...
                <div>
                  ...
                  <div className="mt-4 border-l-2 border-foreground/10 pl-4">
                    <p className="text-xs leading-relaxed text-muted-foreground/50">
                      The risk disclosure and T&C screens are shown once,
            ...
            <div className="mt-20 md:mt-32">
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-4">
                ...
                <ImagePlaceholder
                  ...
                  caption="Profile verification required — with clear resolution path"
                  aspectRatio="aspect-[3/4]"
                  variant="screen"
                />
                <ImagePlaceholder
          ...
          <section id="outcome" className="px-6 py-24 md:px-[250px] md:py-32">
            ...
            <h2 className="mt-4 max-w-[22ch] text-3xl font-medium tracking-tight md:text-4xl">
              The first time a licensed SA bank shipped crypto as a native feature
            </h2>
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-2 md:gap-12">
              <div>
                ...
                <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                  ...
                  broader rollout. The first-purchase completion rate — not
                  portfolio size, not trading volume — was the primary signal
                  being tracked. The low minimum entry (R50) and ZAR-first
                  interface were intentional bets on a first-buy market, not
                  an active-trader market.
                </p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-foreground/80">
                ...
                <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                  ...
                  engine. This compressed the time to launch significantly and
                  removed regulatory risk from the product team. The design
                  challenge was making a complex three-party arrangement — user,
                  TymeBank, Paxos — feel like a two-party transaction.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="mt-12 grid gap-12 md:grid-cols-2 md:gap-20">
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    Indicative pricing is genuinely difficult to communicate
                    without sounding evasive. The disclaimer &quot;Price may
                    change by the time you confirm&quot; is accurate but
                    unsatisfying. In a regulated banking environment, users
                    expect the number they see to be the number they pay.
                    This is a structural feature of crypto settlement, not
                    a design failure — but explaining that in two lines without
                    creating anxiety remains an unsolved problem.
                  </p>
                </div>
              </div>
              <div className="space-y-8">
