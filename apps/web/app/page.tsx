...
const COMPACT_PROJECTS: CompactProject[] = [
  {
    ...
    desc: "Rebuilt brand and DEX interface to restore user confidence post-market crash.",
    role: "Product Designer",
    outcome: "Full rebrand + token launchpad shipped to mainnet.",
  ...
  },
  {
    ...
    desc: "Designed a matching flow where AI handles the friction users avoid.",
    role: "Product Designer & Builder",
    outcome: "0-to-1 MVP designed and built. AI-driven matching flow.",
  ...
  },
  {
    ...
    desc: "Turned saving from a chore into a habit for first-time Filipino bank users.",
    role: "UX Designer",
    outcome: "Goal-based savings shipped to millions of GoTyme users.",
